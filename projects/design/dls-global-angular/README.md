...
@include boeing-meso("@dasdigitalplatform/dls-global-assets/dist/fonts");
```
...
1. In `projects/design/dls-global-angular/styles/material/components` create a new SCSS file for the component. The simplest approach is to copy one of the existing files and rename it. For example, if you are customizing the Angular Material Menu component, copy or create the file and name it `_menu.scss`
...
Run `ng test dls-global-angular` to execute the unit tests via [Karma](https://karma-runner.github.io).
